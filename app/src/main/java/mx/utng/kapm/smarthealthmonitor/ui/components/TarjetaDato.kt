...
fun TarjetaDato(
    ...
    icono: ImageVector? = null  // ← Parámetro opcional para el reto
) {
    ElevatedCard(
        ...
        Column(
            ...
            Row(
                ...
                // Ícono opcional a la izquierda del valor
                if (icono != null) {
                    Icon(
                        imageVector = icono,
...
// Preview actualizado con íconos
    ...
    SmartHealthMonitorTheme {
        Column(
            ...
            TarjetaDato(
                ...
                icono = Icons.Default.DirectionsWalk  // 🚶 para Pasos
            )
        }
    }
}